...
$requete="SELECT a.reference, a.prix, a.description, a.photo, f.intitule FROM articles AS a, familles AS f WHERE reference='".$_GET['reference']."' AND a.famillesID=f.ID ";
